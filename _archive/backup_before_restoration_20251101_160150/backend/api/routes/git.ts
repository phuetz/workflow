 ...
 */
router.post('/repositories/:id/commit', async (req, res) => {
  try {
    const gitService = getGitService();
    const { id } = req.params;
    const userId = req.headers['x-user-id'] as string || 'system';
 ...
 */
router.post('/repositories/:id/push', async (req, res) => {
  try {
    const gitService = getGitService();
    const { id } = req.params;
    const userId = req.headers['x-user-id'] as string || 'system';
 ...
 */
router.post('/repositories/:id/pull', async (req, res) => {
  try {
    const gitService = getGitService();
    const { id } = req.params;
    const userId = req.headers['x-user-id'] as string || 'system';
 ...
 */
router.post('/repositories/:id/branches', async (req, res) => {
  try {
    const gitService = getGitService();
    const { id } = req.params;
    const userId = req.headers['x-user-id'] as string || 'system';

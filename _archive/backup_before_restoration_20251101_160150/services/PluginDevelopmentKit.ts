...
export class PluginDevelopmentKit {
  ...
  async createPlugin(scaffold: PluginScaffold): Promise<PluginTemplate> {
    ...
    const pluginTemplate: PluginTemplate = {
      ...
      documentation: this.generateDocumentation(scaffold),
  ...
  private generateDocumentation(scaffold: PluginScaffold): string {
  ...
  private generateManifest(name: string, template: PluginTemplate, options: unknown): string {
  ...
  private generatePackageJson(name: string, template: PluginTemplate, options: unknown): string {
      name,
      version: '1.0.0',
      description: options.description || 'Plugin description',
      main: 'dist/index.js',

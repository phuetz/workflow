...
export class VersionControlService {
  ...
  private async detectMergeConflicts(_repositoryId: string, _sourceBranch: string, _targetBranch: string): Promise<MergeConflict[]> { // eslint-disable-line @typescript-eslint/no-unused-vars
  ...
  private initializeSampleData(): void {
    ...
    this.createBranch(sampleRepo.id, 'main').then(_branch => { // eslint-disable-line @typescript-eslint/no-unused-vars
      // Create some sample commits
      this.createSampleCommits(sampleRepo.id, 'main');
    });
  }

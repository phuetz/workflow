...
router.get('/errors', async (req, res) => {
  try {
    ...
    const filter: ErrorQueryFilter = {
      ...
      errorTypes: req.query.errorTypes ? (req.query.errorTypes as string).split(',') as ErrorType[] : undefined,
      severities: req.query.severities ? (req.query.severities as string).split(',') as ErrorSeverity[] : undefined,

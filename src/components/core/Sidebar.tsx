...
import { ChevronDown, ChevronRight, Plus, Search, Zap, MessageSquare, Database, Brain, Settings, GitBranch, Filter, ArrowRight, Download, Save, Upload, Code, Globe, Mail, Clock, Cloud, FileText, Cpu, Share2, Box, Layers, Terminal, Webhook, Repeat, Shuffle, type LucideIcon } from 'lucide-react';
import { nodeTypes, nodeCategories } from '../../data/nodeTypes';
import { useWorkflowStore } from '../../store/workflowStore';

// Icon mapping for node types
const IconMap: Record<string, LucideIcon> = {
  Zap, MessageSquare, Database, Brain, Settings, GitBranch, Filter, Code, Globe, Mail, Clock, Cloud, FileText, Cpu, Share2, Box, Layers, Terminal, Webhook, Repeat, Shuffle, Plus, ArrowRight
};
...
export default function Sidebar() {
  ...
  const filteredNodes = useMemo(() => {
    return Object.entries(nodeTypes).filter(([_, node]) => {
            ...
            <div key={catKey} className="mb-4">
              ...
              {isExpanded && (
                <div className="mt-2 space-y-2 ml-2">
                  {categoryNodes.map(([nodeType, node]) => (
                    <div
                      key={nodeType}

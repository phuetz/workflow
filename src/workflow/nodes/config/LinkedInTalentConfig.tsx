/**
 * LinkedIn Talent Node Configuration
 */

import React, { useState } from 'react';

interface LinkedInTalentConfigProps {
  config: Record<string, unknown>;
  onChange: (config: Record<string, unknown>) => void;
}

export const LinkedInTalent: React.FC<LinkedInTalentConfigProps> = ({ config, onChange }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
        ...
        <p className="text-xs text-blue-700">Requires LinkedIn Talent API credentials.</p>
      </div>
    </div>
  );
};

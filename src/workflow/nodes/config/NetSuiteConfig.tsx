...
interface NetSuiteConfigProps {
  config: Record<string, unknown>;
  onChange: (config: Record<string, unknown>) => void;
}

export const NetSuite: React.FC<NetSuiteConfigProps> = ({ config, onChange }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-orange-50 border border-orange-200 rounded-md p-3">
        ...
        <p className="text-xs text-orange-700">Requires NetSuite API credentials.</p>
      </div>
    </div>
  );
};

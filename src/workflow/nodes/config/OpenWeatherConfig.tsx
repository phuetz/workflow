/**
 * OpenWeather Node Configuration
 */

import React, { useState } from 'react';

interface OpenWeatherConfigProps {
  config: Record<string, unknown>;
  onChange: (config: Record<string, unknown>) => void;
}

export const OpenWeather: React.FC<OpenWeatherConfigProps> = ({ config, onChange }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
        ...
        <p className="text-xs text-blue-700">OpenWeather utility for data processing.</p>
      </div>
    </div>
  );
};

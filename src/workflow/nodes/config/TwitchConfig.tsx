...
export const Twitch: React.FC<TwitchConfigProps> = ({ config, onChange }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-purple-50 border border-purple-200 rounded-md p-3">
        ...
        <p className="text-xs text-purple-700">Requires Twitch API credentials.</p>
      </div>
    </div>
  );
};

/**
 * Wistia Node Configuration
 */

import React, { useState } from 'react';

interface WistiaConfigProps {
  config: Record<string, unknown>;
  onChange: (config: Record<string, unknown>) => void;
}

export const Wistia: React.FC<WistiaConfigProps> = ({ config, onChange }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
        ...
        <p className="text-xs text-blue-700">Requires Wistia API credentials.</p>
      </div>
    </div>
  );
};

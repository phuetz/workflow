...
interface XMLParserV2ConfigProps {
  config: Record<string, unknown>;
  onChange: (config: Record<string, unknown>) => void;
}

export const XMLParserV2: React.FC<XMLParserV2ConfigProps> = ({ config, onChange }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-green-50 border border-green-200 rounded-md p-3">
        ...
        <p className="text-xs text-green-700">XML Parser utility for data processing.</p>
      </div>
    </div>
  );
};
